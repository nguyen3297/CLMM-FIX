                ...
                <div class="col-md-12">
                    ...
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Thêm Hỗ Trợ</h3>
                                    ...
                                    <tr data-id="{{ $row->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <button
                                                    onclick="statusContact({{ $row->id }}, 'delete', 'Bạn chắc chắn muốn xóa ?')"
                                                    type="button"
                                                ...
                                                <div class="dropdown-menu fs-sm"
                                                    ...
                                                    <a class="dropdown-item" onclick="statusContact({{ $row->id }}, 'show', 'Bạn chắc chặn muốn hiện ?')">Hiện Link</a>
                                                    <a class="dropdown-item" onclick="statusContact({{ $row->id }}, 'hidden', 'Bạn chắc chặn muốn ẩn ?')">Ẩn Link</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
