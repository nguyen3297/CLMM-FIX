                ...
                if (data.status == true) {
                    ...
                    if (data.data_momo) {
                        ...
                        for (let momo of data.data_momo) {
                            ...
                            table_two += `<td>${status_momo[momo.status]}</td>`;
                            table_two += `<td><strong><span class="text-danger">${settings.transfers_today.times}</span> lần</strong></td>`;
                            table_two += `<td><strong><span class="text-danger cash-format">${number_format(settings.transfers_today.amount)}</span></strong></td>`;
                            table_two += "</tr>";
                ...
                if (data.status == true) {
                    if (data.dayTop.status == true) {
                        ...
                        for (let top of data.dayTop.data) {
                            ...
                            html_daytop += `<td class="col-xs-5 text-center"><span class="label label-danger">${number_format(top.amount)}</span></td>`;
                            html_daytop += `<td class="col-xs-5 text-center"><span class="label label-danger">${number_format(top.gift)}</span></td>`;
                            html_daytop += '</tr>';
                        }
    ...
    return {
        ...
        noti_win: function (data) {
            ...
            new Notify({
                ...
                autoclose: true,
                customIcon: '<img src="https://i.imgur.com/D69n2Ak.png" style="width: 30px; height: 30px;">',
            })
        }
